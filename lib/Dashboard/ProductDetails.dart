...
class ProductDetilas extends StatefulWidget {
  var itemList;
  List<Delivered> newOrderList = List();
  int index;
  ProductDetilas({this.itemList,this.newOrderList,this.index});
  @override
  _OrderDetailsState createState() => _OrderDetailsState();
}

class _OrderDetailsState extends State<ProductDetilas> {
  String date;
  var address;
